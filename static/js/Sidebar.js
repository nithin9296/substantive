...
Sidebar.prototype.init = function () {
  ...
  this.addStencilPalette('arrows', mxResources.get('arrows'), src = '/static/stencils/arrows.xml',
    ';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2')
  this.addUmlPalette(false)
  this.addBpmnPalette(dir, false)
  this.addStencilPalette('flowchart', 'Flowchart', src = '/static/stencils/flowchart.xml',
    ';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2')
...
Sidebar.prototype.addBasicPalette = function (dir) {
  this.addStencilPalette('basic', mxResources.get('basic'), src = '/static/stencils/basic.xml',
    ';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2',
    null, null, null, null, [
...
Sidebar.prototype.init = function () {
  ...
  this.addImagePalette('clipart', mxResources.get('clipart'), src = '/static/stencils/clipart/', '_128x128.png',
    ['Earth_globe', 'Empty_Folder', 'Full_Folder', 'Gear', 'Lock', 'Software', 'Virus', 'Email',
      'Database', 'Router_Icon', 'iPad', 'iMac', 'Laptop', 'MacBook', 'Monitor_Tower', 'Printer',
      'Server_Tower', 'Workstation', 'Firewall_02', 'Wireless_Router_N', 'Credit_Card',
      'Piggy_Bank', 'Graph', 'Safe', 'Shopping_Cart', 'Suit1', 'Suit2', 'Suit3', 'Pilot1',
...
Sidebar.prototype.addYourPalette = function (expand) {
  ...
  var fns = [
    this.createVertexTemplateEntry('rounded=1;whiteSpace=wrap;html=1;', 120, 60, '', 'Start', null, null, 'rounded rect rectangle box'),
    this.createVertexTemplateEntry('whiteSpace=wrap;html=1;aspect=fixed;', 80, 80, '', 'Manual Activity', null, null, 'square'),
    this.createVertexTemplateEntry('rhombus;whiteSpace=wrap;html=1;', 80, 80, '', 'decision', null, null, 'diamond rhombus if condition decision conditional question test'),
    this.createEdgeTemplateEntry('startArrow=diamondThin;startFill=0;startSize=14;endArrow=block;endFill=1;endSize=6;html=1;', 100, 0, '', 'Conditional Flow', null, 'bpmn conditional flow'),
    this.createVertexTemplateEntry('shape=document;whiteSpace=wrap;html=1;boundedLbl=1;', 120, 80, '', 'Document'),
    this.createVertexTemplateEntry('ellipse;shape=umlControl;whiteSpace=wrap;html=1;', 70, 80, 'Control Object', 'Control Object', null, null, 'uml control object'),
    this.createVertexTemplateEntry('shape=process;whiteSpace=wrap;html=1;backgroundOutline=1;', 120, 60, '', 'Automated Activity', null, null, 'process task'),
    this.createVertexTemplateEntry('shape=callout;whiteSpace=wrap;html=1;perimeter=calloutPerimeter;', 120, 80, '', 'Absence of Control', null, null, 'bubble chat thought speech message')
  ]

  this.addPaletteFunctions('Internal Control Process', 'Internal Control Process', (expand != null) ? expand : true, fns)
}
